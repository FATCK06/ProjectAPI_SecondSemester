...
export default function NormasConjunto() {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <div><h1 className={styles.title}>Normas de Conjunto</h1><p className={styles.subtitle}>Gerencie e consulte todas as normas de categoria Conjunto.</p></div>
      </div>
